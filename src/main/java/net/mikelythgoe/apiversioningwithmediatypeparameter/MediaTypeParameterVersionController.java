...
public class MediaTypeParameterVersionController {
    ...
    @GetMapping(value = "/hello",  version = "1.0", produces = "application/json")
    ...
    @GetMapping(value = "/hello", version = "2.0", produces = "application/json")
    public String helloV2point0Json() {
        return "{\"message\":\"Hello Version 2.0\"}";
    }
    ...
    @GetMapping(value = "/hello", version = "2.0", produces = "application/xml")
    public String helloV2point0Xml() {
        return "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\n" +
                " <root>\n" +
                "     <message>Hello Version 1</message>\n" +
                " </root>";
    }
